                        ...
                        <div className="aboutData col-8">
                            ...
                            <div className="container">
                                ...
                                <div className="about-content">
                                    ...
                                    <br />
                                    <div className="registerMember" data-aos="fade-up">
                                        <Register />
                                    </div>
                                </div>
                                <div id="types-fee">
                                    ...
                                    <div className="membership-details">
                                        <p data-aos="fade-up">Membership Types Mazedan welcome all the research scholars, professors, R&D professionals and industry persons to join us as the professional member of Mazedan. Our objective is to facilitate the exchange of information and ideas freely and promote research activities. Membership categories include two types of membership, individual and institutional. The category of Individual Member consists of four grades, such as Fellow Member, Executive Member, Life Member and Associate Member whereas Institutional Membership includes Corporate Institutions and Educational Institutions</p>

                                        <h3 data-aos="fade-up">Fellow Member:</h3>
                                        <p data-aos="fade-up">The grade of Fellow is conferred on Professor, Doctors, Engineers and Scientists and shall be conferred only on the invitation of the Mazedan upon a person of distinction and outstanding qualifications, and who has made extraordinary contributions in research.</p>

                                        <h3 data-aos="fade-up">Executive Member:</h3>
                                        <p data-aos="fade-up">In this grade, the executive committee considers membership of the person based on significant contribution in Mazedan. The executive members vote in the constitution of the executive body.</p>

                                        <h3 data-aos="fade-up">Life Member:</h3>
                                        <p data-aos="fade-up">fter successful completion of the three years of the associate membership, the executive committee can recommend converting the associate grade into the life membership.</p>

                                        <h3 data-aos="fade-up">Associate Member:</h3>
                                        <p data-aos="fade-up">The grade of Associate Member is conferred to those who have made a significant professional contribution and demonstrated professional competence in the relevant fields. The candidate shall be a PhD scholar from an accredited educational Institution can directly be entered in the grade of Associate Member. Graduate and/or Postgraduate Doctors and Engineers can also join to Mazedan as Associate Member.</p>
                                        <br />
                                        <div className="membership-table" data-aos="fade-up">
                                ...
                                <div id="benefits-row">
                                    ...
                                    <div className="data-row">
                                        <p data-aos="fade-up">Mazedan endeavour to accumulate researchers, academics, doctors, scientists, engineering professionals and also universities, institutes, on a global platform to promote new ideas, ideas and latest trends to create a promising and bright future for mankind. Therefore, we have provided a lot of free research tools on Mazedan's platform. We have created Digital Library with easy and free access of research database by any scholar from anywhere. By becoming a member of Mazedan one can also gain access to research tools that are limited to the public. Members of Mazedan get the benefit of fee waiver and discounts in the entry of Mazedan conferences, and other activities. There are many benefits to joining with Mazedan, some of which are outlined in the points below.</p>
                                        <ul>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p> Free online access to all conference publications and journal publications by Mazedan Associated Network.</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Mazedan Associate Network provides financial support for research work in all engineering areas and more.</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Get a chance to be a part of the conference, seminar organizing member</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Possibility to become a member of the editorial board of research journals</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Members can avail free plagiarism scan facility of their research material through Mazedan. Mazedan uses the Turnitin for plagiarism check</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Members can get research assistants in article writing, publishing and experimentation</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Discount on registration fee (10% - 15%) for technical and academic conferences organized by Mazedan Associate Network.</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>Empower your knowledge by attending scientific seminars with discounted fees on the latest trends and research topics.</p> </li>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>  <p>All members can avail ID cards and membership certificates, which will be dispatched 1-2 months after membership approval. </p> </li>
                                        </ul>
                                    </div>
                                </div>
                                <div id="term-condition">
                                    ...
                                    <div className="data-row">
                                        <p data-aos="fade-up">Membership is granted on the basis of the following conditions.</p>
                                        <ul>
                                            <li data-aos="fade-up"> <span className="square-icon">&#10065;</span>
