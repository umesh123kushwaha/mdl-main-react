                            ...
                            <div className="container">
                                ...
                                <div className="aims">
                                    ...
                                    <ul>
                                        ...
                                        <li> <span className="square-icon">&#10065;</span>  <p>undertakes and carries on research and development work through the establishment of laboratories, experiment centers</p> </li>
                                        <li> <span className="square-icon">&#10065;</span>  <p>provide training and conduct advance certification course for the professionals as well as for learners.</p> </li>
                                        <li> <span className="square-icon">&#10065;</span>  <p>takes government-funded projects to carry some development work for nation-building.</p> </li>
                                        ...
                                        <li> <span className="square-icon">&#10065;</span>  <p>establish the local chapters in institutions and universities to impart the research culture and support in various technical activities.</p> </li>
                                        <li> <span className="square-icon">&#10065;</span>  <p>establishes, maintains, and operates educational institutions, schools, and hostels for the benefit of the children.</p> </li>
                                        <li> <span className="square-icon">&#10065;</span>  <p>engaged in sharing knowledge through the organization of various conferences, seminars, and workshops on various subjects from time to time throughout the year</p> </li>
                                        <li> <span className="square-icon">&#10065;</span>  <p>assist the young scholars and researchers by guiding in technical writing, experimentation and in software learnings. </p> </li>
                                    </ul>
