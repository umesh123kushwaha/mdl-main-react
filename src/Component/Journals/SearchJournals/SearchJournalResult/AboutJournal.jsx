          ...
          <div className="upSection">
            ...
            <div className="text-justify">
              ...
              <div className="scope">
                ...
                <h3 className="color-lightBlue"> <ImSearch /> &nbsp; Scope</h3>
                <p>
              ...
              <div className="article-process">
                <h3 className="color-lightBlue"><FaDollarSign /> &nbsp; Article Processing Fee and Journal Subscription</h3>
              ...
              <div className="plg-policy">
                <h3 className="color-lightBlue"><ImBlocked />&nbsp; Plagiarism Policy</h3>
              ...
              <div className="rew-policy">
                <h3 className="color-lightBlue"><ImSearch />&nbsp; Review Policy</h3>
                <p>MTESD follows a Closed Review model, wherein reviewers are aware of authors' identities, but authors do not know the reviewers. The editorial process involves initial manuscript evaluation by the Editor, with further review by at least two experts if the manuscript meets the minimum criteria. The time for the review process is contingent on referee response.</p>
              </div>
              <div className="policy-time">
                <h3 className="color-lightBlue">⌚&nbsp; Decision and Publication Time</h3>
                <p>For regular publication (free of charge), MTESD maintains an average first decision time of 2 weeks and a publication time of approximately 10 weeks. Authors also have the option of fast-track publication on a paid basis, ensuring publication within 7 days. We strive to provide a timely and efficient platform for disseminating valuable research to the global community</p>
              </div>
              <div className="abstract">
                <h3 className="color-lightBlue"><ImAddressBook />&nbsp; Abstracting & Indexing:</h3>
                <div className="g-1 d-flex item-center">
                  <img src="/public/images/JournalSponser/google-scholer.png" alt="" />
                  <img src="/public/images/JournalSponser/j-gate.png" alt="" />
                  <img src="/public/images/JournalSponser/project-muse.png" alt="" />
                  <img src="/images/JournalSponser/doag.png" alt="" />
                  <img src="/public/images/JournalSponser/jstor.png" alt="" />
                  <img src="/public/images/JournalSponser/nki.jpeg" alt="" />
                </div>
