                        ...
                        <div className="middle-column col-8">
                            ...
                            <div className="container">
                                <div className="upSection">
                                    ...
                                    <div className="text-justify first-column">
                                        <p data-aos="fade-up">Mazedan publishes the research results, review articles and survey report and events proceedings in form of Journal, Book, Thesis, Report, Proceedings.</p>
                                        <div className="mdl">
                                            <h3 data-aos="fade-up">Mazedan Digital Library</h3>
                                            <p data-aos="fade-up">A digital platform name Mazedan Digital Library is used to publish and access the published data. It is a research, discovery and networking platform containing:</p>
                                            <ul className='container'>
                                                <li data-aos="fade-up">The Full-Text Collection of all MIRA publications, including journals, conference proceedings, technical magazines, newsletters and books </li>
                                                <li data-aos="fade-up">A collection of curated and hosted full-text publications from select publishers.</li>
                                                <li data-aos="fade-up">The MIRA Guide to Research Literature, a comprehensive bibliographic database focused exclusively on the Engineering and Medical research</li>
                                                <li data-aos="fade-up">A richly interlinked set of connections among authors, works, institutions, and specialized communities. It accomplish and is carrying out an important stake in research communication process, while in its debut publications it could achieve highly constructive research articles</li>
                                                <li data-aos="fade-up">To say, in emphasis that all the Journals emanated from the MIRA are proud declared to be Free Journals. Mazedan Journals are strictly committed to publish blind peer reviewed original research articles treating modern research sciences and its manifold applications, in relation with to any field of study on par with international standards in respective journals..</li>
                                                <li data-aos="fade-up">The aim of the Mazedan publication is to disseminate original, scientific, theoretical or applied research in the field of Engineering and allied fields, to dispense a platform for publishing results and research with a strong empirical component, to aqueduct the significant gap between research and practice by promoting the publication of original, novel, industry-relevant research, to seek original and unpublished research papers based on theoretical or experimental works for the publication globally, to publish original, theoretical and practical advances in Engineering, Technology, Science, Management, and Humanities, all its related stream, to impart a platform for publishing results and research with a strong empirical component, to create a bridge for significant gap between research and practice by promoting the publication of original, novel, industry-relevant research, to solicit original and unpublished research papers, based on theoretical or experimental works.</li>
                                                <li data-aos="fade-up">Papers for the regular issues of the journal can be submitted, round the year, electronically. For it, respective journal inform to authors time to time for it. After the final acceptance of the paper, based upon the detailed review process, the paper will immediately be published online. However, assignment of the paper to a specific Volume / Issue of the journals will be taken up by the Editorial Board later; and the author will be intimated accordingly. For Theme Based Special Issues, time bound Special Call for Papers will be announced and the same will be applicable for that specific issue only.
                                                </li>
                                                <li data-aos="fade-up">All submitted papers will be reviewed by double blind peer review process which may take minimum 01 to 03 weeks from the date of submission. We are advising to all the author(s), do not submit same paper to the multiple journals. You should wait for review status of paper
                                                </li>
                                                <li data-aos="fade-up">Despite criticisms, peer review is still the only widely accepted method for research validation.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div id="publish-table">
                                    <h3 data-aos="fade-left">How you can publish?</h3>
                                    <p data-aos="fade-up">Mazedan publishes the following articles with proper ISBN/ISSN. The publication fee is different for different category.</p>
